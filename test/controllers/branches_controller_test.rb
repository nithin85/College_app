...
class BranchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post branches_url, params: { branch: { branch_name: @branch.branch_name, college_id: @branch.college_id } }
    end
  ...
  test "should update branch" do
    patch branch_url(@branch), params: { branch: { branch_name: @branch.branch_name, college_id: @branch.college_id } }
